...
class FileService:
    ...
    async def save_temp_sequence(sequence: str, generation_id: uuid.UUID) -> str:
        ...
        try:
            ...
            # Сохраняем последовательность как текст
            ...
            # Возвращаем локальный путь для Celery tasks
    ...
    async def upload_external_sequence(user_id: uuid.UUID,
        ...
        try:
            # Валидация - проверяем что файл содержит только 0 и 1
            ...
            # Сохраняем очищенную последовательность
